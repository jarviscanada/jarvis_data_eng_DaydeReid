...
public class QuoteDao implements CrudRepository<Quote, String> {
  ...
  public Quote save(Quote quote) {
    if (existsById(quote.getTicker())) {
      int updatedRowNo = updateQuote(quote);
      if (updatedRowNo != 1) {
  ...
  /**
   * Helper function which gets a quote by its ticker
   */
  ...
  /**
   * Helper function which gets all quotes
   */
  ...
  /**
   * Helper function which gets the total number of quotes
   */
  ...
  /**
   * Helper function which deletes a quote by its ticker
   */
  ...
  /**
   * Helper function which deletes all quotes
   */
