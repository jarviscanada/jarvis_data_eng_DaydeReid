...
public class Trader implements Entity<Integer> {
  ...
  public boolean equals(Object o) {
    ...
    System.out.println(id + "=="+ trader.id);
    System.out.println(firstName + "=="+ trader.firstName);
    System.out.println(lastName + "=="+ trader.lastName);
    System.out.println(dob + "=="+ trader.dob);
    System.out.println(country + "=="+ trader.country);
    System.out.println(email + "=="+ trader.email);
