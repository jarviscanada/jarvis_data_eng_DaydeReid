...
public class OrderController {
  ...
  @ApiOperation(value = "Submit a market order", notes = "Submit a market order from the given DTO")
  @ApiResponses(value = {@ApiResponse(code = 404, message = "accountId or ticker is not found"),
  @ApiResponse(code = 400, message = "Unable to perform order due to user input")})
