...
public class TraderAccountController {
  ...
  @ApiOperation(value = "Create a trader with an account.", notes = "TraderId and AccountId are auto-generated by the database, and the should be identical. Each trader only has one account")
  @ResponseStatus(HttpStatus.CREATED)
  @ResponseBody
  @PostMapping(path = "/firstname/{firstname}/lastname/{lastname}/dob/{dob}/country/{country}/email/{email}", produces = {
  ...
  @ApiOperation(value = "Create a trader and an account with DTO", notes = "TraderId and AccountId are auto-generated by the database, and the should be identical. Each trader only has one account")
  @ResponseStatus(HttpStatus.CREATED)
  @ResponseBody
  ...
  @ApiOperation(value = "Delete a trader", notes = "Delete a trader IFF its account amount is 0, and it has no open positions. Also deletes the associated account and security orders.")
  ...
  @ApiOperation(value = "Deposit some funds into a trader's account", notes = "Deposit funds into the account associated with the given trader ID.")
  @ApiResponses(value = {@ApiResponse(code = 404, message = "traderId is not found"),
      @ApiResponse(code = 400, message = "Unable to deposit due to user input (e.g. deposit amount may not be positive)")})
  @ResponseStatus(HttpStatus.OK)
  @ResponseBody
  ...
  @ApiOperation(value = "Withdraw some funds from a trader's account", notes = "Withdraw funds from the account associated with the given trader ID.")
  @ApiResponses(value = {@ApiResponse(code = 404, message = "traderId is not found"),
      @ApiResponse(code = 400, message = "Unable to withdraw due to user input (e.g. withdraw amount might be larger that account amount)")})
  @ResponseStatus(HttpStatus.OK)
  @ResponseBody
